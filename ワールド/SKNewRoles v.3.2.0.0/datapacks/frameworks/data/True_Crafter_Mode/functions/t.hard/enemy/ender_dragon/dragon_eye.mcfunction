...
execute if entity @s[scores={T.HardMoveset1=40..}] if block ~ ~ ~ #True_Crafter_Mode:t.hard/no_collision run summon armor_stand ~ ~0.68 ~ {Marker:1b,Invisible:1b,Tags:[T.HardEyeShot,T.HardShot2,T.HardShot0],DisabledSlots:4144959}
execute if entity @s[scores={T.HardMoveset1=40..}] if block ~ ~ ~ #True_Crafter_Mode:t.hard/no_collision run playsound entity.ender_dragon.shoot hostile @p ~ ~ ~ 2 2
