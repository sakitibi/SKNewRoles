...
#どういうわけかゴーレムを分解
execute as @e[type=iron_golem,distance=..5] at @s run function True_Crafter_Mode:t.hard/enemy/evoker/destroy_golem 
...
execute if entity @s[scores={T.HardMoveset1=40}] if entity @a[distance=..5] rotated ~ 0 if block ^ ^ ^-1 #True_Crafter_Mode:t.hard/no_collision run function True_Crafter_Mode:t.hard/enemy/common/back_warp
execute if entity @s[scores={T.HardMoveset1=40}] if entity @a[distance=..5] rotated ~ 0 unless block ^ ^ ^-1 #True_Crafter_Mode:t.hard/no_collision run function True_Crafter_Mode:t.hard/enemy/common/foward_warp
execute if entity @s[scores={T.HardMoveset1=40}] if entity @a[distance=5..16] rotated ~ 0 run function True_Crafter_Mode:t.hard/enemy/common/foward_warp
