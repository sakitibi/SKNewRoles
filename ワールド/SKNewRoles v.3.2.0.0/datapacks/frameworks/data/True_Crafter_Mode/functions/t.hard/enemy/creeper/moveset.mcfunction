...
# 難易度によっては3回で死ぬ
    ...
    execute if score @s T.HardMoveset3 matches 3 run function True_Crafter_Mode:t.hard/enemy/common/go_to_void
...
# 起爆中なら近くのエンティティを逃がす
    execute if entity @s[tag=T.HardIgnited] as @e[distance=0.1..6,type=#True_Crafter_Mode:t.hard/hostiles] at @s facing entity @e[type=creeper,limit=1,sort=nearest] eyes run function True_Crafter_Mode:t.hard/enemy/common/dodge_creeper
