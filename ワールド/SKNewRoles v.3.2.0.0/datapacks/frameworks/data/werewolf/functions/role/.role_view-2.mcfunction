...
execute as @a[team=Ponkotsu,tag=wanashi_dummy] at @s run playsound minecraft:game_start_2 master @s
execute as @a[team=Ponkotsu,tag=wanashi_dummy] run title @s title [{"text":"\uF811\uE104\uF811","font":"role"}]
execute as @a[team=Ponkotsu,tag=uranai_dummy] at @s run playsound minecraft:game_start_1 master @s
execute as @a[team=Ponkotsu,tag=uranai_dummy] run title @s title [{"text":"\uF811\uE003\uF811","font":"role"}]
execute as @a[team=Ponkotsu,tag=reinou_dummy] at @s run playsound minecraft:game_start_1 master @s
execute as @a[team=Ponkotsu,tag=reinou_dummy] run title @s title [{"text":"\uF811\uE004\uF811","font":"role"}]
execute as @a[team=Ponkotsu,tag=kishi_dummy] at @s run playsound minecraft:game_start_1 master @s
execute as @a[team=Ponkotsu,tag=kishi_dummy] run title @s title [{"text":"\uF811\uE005\uF811","font":"role"}]
execute as @a[team=Ponkotsu,tag=hoankan_dummy] at @s run playsound minecraft:game_start_1 master @s
execute as @a[team=Ponkotsu,tag=hoankan_dummy] run title @s title [{"text":"\uF811\uE007\uF811","font":"role"}]
execute as @a[team=Ponkotsu,tag=ojousama_dummy] at @s run playsound minecraft:game_start_1 master @s
execute as @a[team=Ponkotsu,tag=ojousama_dummy] run title @s title [{"text":"\uF811\uE009\uF811","font":"role"}]
execute as @a[team=Ponkotsu,tag=saibankan_dummy] at @s run playsound minecraft:game_start_1 master @s
