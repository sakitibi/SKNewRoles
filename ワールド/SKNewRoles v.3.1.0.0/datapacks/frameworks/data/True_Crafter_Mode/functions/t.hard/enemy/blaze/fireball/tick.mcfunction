...
# 移動
    execute at @s if block ~ ~ ~ #True_Crafter_Mode:t.hard/no_collision run tp ^ ^ ^0.26
    execute at @s if block ~ ~ ~ #True_Crafter_Mode:t.hard/no_collision run tp ^ ^ ^0.26
    execute at @s if block ~ ~ ~ #True_Crafter_Mode:t.hard/no_collision run tp ^ ^ ^0.26
    execute at @s if block ~ ~ ~ #True_Crafter_Mode:t.hard/no_collision run tp ^ ^ ^0.26
...
# 地形接触
    execute at @s unless block ~ ~ ~ #True_Crafter_Mode:t.hard/no_collision positioned ^ ^ ^-1 run function True_Crafter_Mode:t.hard/enemy/blaze/fireball/hit

# エンティティに接触
    execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @p[dx=0] run function True_Crafter_Mode:t.hard/enemy/blaze/fireball/hit
