...
#前をチェックして飛びかかり
execute positioned ^ ^ ^-0.5 facing entity @e[type=#True_Crafter_Mode:t.hard/human,distance=5..16,limit=1,sort=nearest] feet positioned ^ ^ ^0.5 if entity @s[distance=..0.22] run scoreboard players add @s[nbt={OnGround:1b}] T.HardMoveset1 1
...
execute if entity @s[scores={T.HardMoveset2=60..}] facing entity @p eyes rotated ~ 0 unless block ^ ^-1 ^-3 #True_Crafter_Mode:t.hard/no_collision if block ^ ^ ^-1 #True_Crafter_Mode:t.hard/no_collision run function True_Crafter_Mode:t.hard/enemy/common/back_step
execute if entity @s[scores={T.HardMoveset2=60..}] facing entity @p eyes rotated ~ 0 unless block ^ ^ ^-1 #True_Crafter_Mode:t.hard/no_collision run function True_Crafter_Mode:t.hard/enemy/common/leap_attack
execute if entity @s[scores={T.HardMoveset2=60..}] facing entity @p eyes rotated ~ 0 if block ^ ^-1 ^-3 #True_Crafter_Mode:t.hard/no_collision run function True_Crafter_Mode:t.hard/enemy/common/leap_attack
...
execute if entity @s[scores={T.HardDig=40},tag=ChuzOnGround,tag=ChuzStandstill] facing entity @e[type=#True_Crafter_Mode:t.hard/zombie_enemy,distance=..16,sort=nearest,limit=1] eyes rotated ~ 0 run function True_Crafter_Mode:t.hard/enemy/common/break_block_forward
