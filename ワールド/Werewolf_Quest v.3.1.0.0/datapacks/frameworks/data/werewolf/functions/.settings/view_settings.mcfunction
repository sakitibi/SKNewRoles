#上段調節
    tellraw @s {"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n[Settings]"}
# 役職人数の詳細設定    
    tellraw @s [{"text":" [役職人数/通常]","color":"gold","clickEvent":{"action":"run_command","value":"/function werewolf:.settings/view_settings_role"}}]  
    tellraw @s [{"text":" [役職人数/Mod]","color":"green","clickEvent":{"action":"run_command","value":"/function werewolf:.settings/view_settings_role_mod"}}]
...
# スキルの詳細設定    
    ...
    tellraw @s [{"text":" [スキル/特殊能力の詳細設定/Mod]","color":"green","clickEvent":{"action":"run_command","value":"/function werewolf:.settings/view_settings_skill_mod"}}]
