...
execute unless entity @a[tag=!hanazonogirl_unlocked_curse,tag=!4] run tag @s add warlock_curse_protected
execute unless entity @a[tag=!4,tag=!warlock_curse_protected] run title @a[tag=Warlock,limit=1] title [{"selector":"@s","color":"green"},{"text":"には魔術が効かない!","color":"green"}]
