#通常
 #占い処理
execute if entity @s[team=Uranai] if score @a[tag=5,limit=1] role matches 1 unless entity @a[tag=!5,team=Tenkai,team=Youko,team=!Witch,tag=!Sorceress] run tellraw @s [{"selector":"@a[tag=5]","color":"red"},{"text":"によって狂人になった。","color":"red"}]
execute if entity @s[team=Uranai] if score @a[tag=5,limit=1] role matches 1 if entity @a[tag=5,team=!Tenkai] run tellraw @s [{"selector":"@a[tag=5]","color":"green"},{"text":"は人狼ではないようだ。","color":"green"}]
...
execute if entity @s[team=Uranai] if score @a[tag=5,limit=1] role matches 2 if entity @a[tag=5,team=!Tenkai,team=!Witch] run tellraw @s [{"selector":"@a[tag=5]","color":"red"},{"text":"は人狼のようだ。","color":"red"}]
