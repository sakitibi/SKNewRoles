# スキル関連
    ...
    # あられ少女スキル
        scoreboard players add @a skill_araregirl_cooltime 0
    #スキル最大回数を指定(0なら無制限)
        execute unless score GameManager skill_araregirl_limit matches 0.. run scoreboard players set GameManager skill_araregirl_limit 1
    #回復タイミングを指定(n/日)
        execute unless score GameManager skill_araregirl_frequency matches 0.. run scoreboard players set GameManager skill_araregirl_frequency 1 