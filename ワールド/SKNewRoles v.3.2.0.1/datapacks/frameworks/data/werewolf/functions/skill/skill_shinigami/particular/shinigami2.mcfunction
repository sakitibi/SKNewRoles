execute as @a[tag=2] run function werewolf:skill/skill_shinigami/.shinigami_store_role
function werewolf:skill/skill_shinigami/.shinigami_change_role
tag @a[tag=2] add copying
function werewolf:skill/skill_shinigami/.shinigami_copy_scoreboard
tag @a[tag=2] remove copying
tellraw @s [{"selector":"@a[tag=2]"},{"text":"の能力を得た。"}]
