...
# マッドシーア
    #マッドシーアスキル処理
    execute as @a[team=Madseer,predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/madseer_skill_cooltime,scores={right_click=1..},predicate=werewolf:is_sneaking] run function werewolf:skill/skill_madseer/madseer_skill/.madseer_result
    execute as @a[team=Madseer,predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/madseer_skill,scores={right_click=1..},predicate=werewolf:is_sneaking] run function werewolf:skill/skill_madseer/madseer_skill/.madseer_result
# しろいぬ
    #しろいぬスキル処理
...
# 狂人薬師
    #狂人薬師スキル処理
    #治癒
    function werewolf:skill/skill_kyoujinkusushi/kyoujinkusushi_health_skill/
    execute as @a[predicate=werewolf:have_skill/kyoujinkusushi_health_skill_cooltime,predicate=!werewolf:is_sneaking,scores={right_click=1..}] run tellraw @s {"text":"今はまだ使えない。"}
    execute as @a[predicate=werewolf:have_skill/kyoujinkusushi_health_skill,predicate=!werewolf:is_sneaking,scores={right_click=1..}] run function werewolf:skill/skill_kyoujinkusushi/kyoujinkusushi_health_skill/kyoujinkusushi_health_skill_result
    #スキルチェンジ
    execute as @a[team=Kyoujinkusushi,predicate=werewolf:is_sneaking,scores={right_click=1..}] run item replace entity @s weapon.mainhand with air
    #寛解
    execute as @a[team=Kyoujinkusushi,predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/kyoujinkusushi_kankai_skill_cooltime,scores={right_click=1..},predicate=werewolf:is_sneaking] run function werewolf:skill/skill_kyoujinkusushi/kyoujinkusushi_kankai_skill/.kyoujinkusushi_kankai_result
    execute as @a[team=Kyoujinkusushi,predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/kyoujinkusushi_kankai_skill,scores={right_click=1..},predicate=werewolf:is_sneaking] run function werewolf:skill/skill_kyoujinkusushi/kyoujinkusushi_kankai_skill/.kyoujinkusushi_kankai_result
# ポイゾナー
    #ポイゾナースキル処理
    execute as @a[team=Poisoner,predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/poisoner_skill_cooltime,scores={right_click=1..},predicate=werewolf:is_sneaking] run function werewolf:skill/skill_poisoner/.poisoner_result
    execute as @a[team=Poisoner,predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/poisoner_skill,scores={right_click=1..},predicate=werewolf:is_sneaking] run function werewolf:skill/skill_poisoner/.poisoner_result
# 黒雪少女
    #黒雪少女処理
    execute as @a[predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/blacksnowgirl_skill_cooltime,scores={right_click=1..}] run function werewolf:skill/skill_blacksnowgirl/.blacksnowgirl_result
    execute as @a[predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/blacksnowgirl_skill,scores={right_click=1..}] run function werewolf:skill/skill_blacksnowgirl/.blacksnowgirl_result
# 自爆魔
    #自爆魔スキル処理
    #キル
    function werewolf:skill/skill_jibakuma/jibakuma_slash_skill/
    execute as @a[predicate=werewolf:have_skill/jibakuma_slash_skill_cooltime,predicate=!werewolf:is_sneaking,scores={right_click=1..}] run tellraw @s {"text":"今はまだ使えない。"}
    execute as @a[predicate=werewolf:have_skill/jibakuma_slash_skill,predicate=!werewolf:is_sneaking,scores={right_click=1..}] run function werewolf:skill/skill_jibakuma/jibakuma_slash_skill/jibakuma_slash_skill_result
    #スキルチェンジ
    execute as @a[team=Jibakuma,predicate=werewolf:is_sneaking,scores={right_click=1..}] run item replace entity @s weapon.mainhand with air
    #自爆
    execute as @a[team=Jibakuma,predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/jibakuma_bomb_skill_cooltime,scores={right_click=1..},predicate=werewolf:is_sneaking] run function werewolf:skill/skill_jibakuma/jibakuma_bomb_skill/.jibakuma_bomb_result
    execute as @a[team=Jibakuma,predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/jibakuma_bomb_skill,scores={right_click=1..},predicate=werewolf:is_sneaking] run function werewolf:skill/skill_jibakuma/jibakuma_bomb_skill/.jibakuma_bomb_result