...
# 森
    #クールタイム設定
    execute as @a[scores={skill_forest_cooltime=1..},predicate=werewolf:set_skill/forest_skill] run loot replace entity @s hotbar.8 loot werewolf:skill/forest_skill/cooltime
    execute as @a[scores={skill_forest_cooltime=0},predicate=werewolf:set_skill/forest_skill_cooltime] run loot replace entity @s hotbar.8 loot werewolf:skill/forest_skill/
# 雪女
    #クールタイム設定
    execute as @a[scores={skill_snowgirl_cooltime=1..},predicate=werewolf:set_skill/snowgirl_skill] run loot replace entity @s hotbar.8 loot werewolf:skill/snowgirl_skill/cooltime
    execute as @a[scores={skill_snowgirl_cooltime=0},predicate=werewolf:set_skill/snowgirl_skill_cooltime] run loot replace entity @s hotbar.8 loot werewolf:skill/snowgirl_skill/