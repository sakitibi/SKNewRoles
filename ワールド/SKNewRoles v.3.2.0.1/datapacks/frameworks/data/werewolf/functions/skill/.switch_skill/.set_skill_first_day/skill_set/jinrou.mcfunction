...
execute as @a[team=Poisoner] run loot replace entity @s hotbar.8 loot werewolf:skill/poisoner_skill/cooltime
execute as @a[team=Jibakuma,scores={skill_mode=0}] run loot replace entity @s hotbar.8 loot werewolf:skill/jibakuma_slash_skill/cooltime
execute as @a[team=Jibakuma,scores={skill_mode=1}] run loot replace entity @s hotbar.8 loot werewolf:skill/jibakuma_bomb_skill/cooltime

execute as @a[team=Madseer] run loot replace entity @s hotbar.8 loot werewolf:skill/madseer_skill/cooltime
execute as @a[team=Shiroinu] run loot replace entity @s hotbar.8 loot werewolf:skill/shiroinu_skill/cooltime
execute as @a[team=Wanashi] run loot replace entity @s hotbar.8 loot werewolf:skill/wanashi_skill/ban
execute as @a[team=Kyoujinkusushi,scores={skill_mode=0}] run loot replace entity @s hotbar.8 loot werewolf:skill/kyoujinkusushi_health_skill/cooltime
execute as @a[team=Kyoujinkusushi,scores={skill_mode=1}] run loot replace entity @s hotbar.8 loot werewolf:skill/kyoujinkusushi_kankai_skill/cooltime
execute as @a[team=Blacksnowgirl] run loot replace entity @s hotbar.8 loot werewolf:skill/blacksnowgirl_skill/cooltime