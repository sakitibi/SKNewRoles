execute as @a[tag=10] run function werewolf:skill/skill_shinigami/.shinigami_store_role
function werewolf:skill/skill_shinigami/.shinigami_change_role
tag @a[tag=10] add copying
function werewolf:skill/skill_shinigami/.shinigami_copy_scoreboard
tag @a[tag=10] remove copying
tellraw @s [{"selector":"@a[tag=10]"},{"text":"の能力を得た。"}]
