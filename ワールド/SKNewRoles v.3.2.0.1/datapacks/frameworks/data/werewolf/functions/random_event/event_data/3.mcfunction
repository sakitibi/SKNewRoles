...
data modify storage wolf_data: delivery_emerald.content.1 set value '[{"text":"目標: 夜になるタイミングで発光ツールを使用\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806","font":"quest_content1"}]'
...
#酸性雨
data modify storage wolf_data: snow_storm.title set value '[{"interpret":true,"nbt":"quest_type.3","storage":"wolf_data:"},{"text":"雪の嵐\\uF806\\uF806\\uF806","font":"quest_title"}]'
data modify storage wolf_data: snow_storm.content.1 set value '[{"text":"目標: 30秒間大雪を耐え凌ぐ\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806\\uF806","font":"quest_content1"}]'
data modify storage wolf_data: snow_storm.content.2 set value '[{"text":"報酬:  -\\uF806\\uF806\\uF806\\uF806","font":"quest_content2"}]'
data modify storage wolf_data: snow_storm.content.3 set value '[{"text":"失敗:  -\\uF806\\uF806\\uF806\\uF806","font":"quest_content3"}]'
data modify storage wolf_data: snow_storm.announce.start.1 set value '[{"text":"[システムアナウンス] クエスト発生: 雪の嵐"}]'
data modify storage wolf_data: snow_storm.announce.start.2 set value '[{"text":"[システムアナウンス] 大気がすごく不安定だ… すぐに大雪が降るだろう"}]'
data modify storage wolf_data: snow_storm.announce.end.1 set value '[{"text":"[システムアナウンス] クエスト終了: 大雪が降り止んだ"}]'
data modify storage wolf_data: snow_storm.announce.success.1 set value '[{"text":""}]'
data modify storage wolf_data: snow_storm.announce.success.2 set value '[{"text":""}]'
data modify storage wolf_data: snow_storm.announce.failed.1 set value '[{"text":""}]'
data modify storage wolf_data: snow_storm.announce.failed.2 set value '[{"text":""}]'
