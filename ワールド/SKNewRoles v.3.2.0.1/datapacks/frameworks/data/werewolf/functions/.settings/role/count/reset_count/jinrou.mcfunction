...
execute if score ポイゾナー Role_count matches 0 run scoreboard players reset ポイゾナー Role_count
execute if score 黒雪少女 Role_count matches 0 run scoreboard players reset 黒雪少女 Role_count
execute if score 自爆魔 Role_count matches 0 run scoreboard players reset 自爆魔 Role_count