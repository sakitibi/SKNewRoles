...
execute if data storage sys: {time_query:6000} as @a unless score @s skill_kyoujinkusushi_health_frequency matches 0 run scoreboard players remove @s skill_kyoujinkusushi_health_frequency 1
execute if data storage sys: {time_query:6000} as @a unless score @s skill_kyoujinkusushi_kankai_frequency matches 0 run scoreboard players remove @s skill_kyoujinkusushi_kankai_frequency 1
execute if data storage sys: {time_query:6000} as @a unless score @s skill_poisoner_frequency matches 0 run scoreboard players remove @s skill_poisoner_frequency 1
execute if data storage sys: {time_query:6000} as @a unless score @s skill_blacksnowgirl_frequency matches 0 run scoreboard players remove @s skill_blacksnowgirl_frequency 1
execute if data storage sys: {time_query:6000} as @a unless score @s skill_jibakuma_slash_frequency matches 0 run scoreboard players remove @s skill_jibakuma_slash_frequency 1
execute if data storage sys: {time_query:6000} as @a unless score @s skill_jibakuma_bomb_frequency matches 0 run scoreboard players remove @s skill_jibakuma_bomb_frequency 1
...
execute if data storage sys: {time_query:6000} as @a if score @s skill_blacksnowgirl_frequency matches 0 unless score @s skill_blacksnowgirl_limit matches 0 run scoreboard players set @s skill_blacksnowgirl_cooltime 0
execute if data storage sys: {time_query:6000} as @a if score @s skill_jibakuma_slash_frequency matches 0 unless score @s skill_jibakuma_slash_limit matches 0 run scoreboard players set @s skill_jibakuma_slash_cooltime 0
execute if data storage sys: {time_query:6000} as @a if score @s skill_jibakuma_bomb_frequency matches 0 unless score @s skill_jibakuma_bomb_limit matches 0 run scoreboard players set @s skill_jibakuma_bomb_cooltime 0