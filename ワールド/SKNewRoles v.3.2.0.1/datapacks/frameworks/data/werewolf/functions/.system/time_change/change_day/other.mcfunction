...
execute if data storage sys: {time_query:6000} as @a unless score @s skill_jackal_slash_frequency matches 0 run scoreboard players remove @s skill_jackal_slash_frequency 1
...
execute if data storage sys: {time_query:6000} as @a if score @s skill_araregirl_frequency matches 0 unless score @s skill_araregirl_limit matches 0 run scoreboard players set @s skill_araregirl_cooltime 0