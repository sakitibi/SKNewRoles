...
#再帰処理
execute if data storage sys: {game_phase:1} unless data storage sys: {time_query:15000} run schedule function werewolf:.system/time_change/change_night 1t append false