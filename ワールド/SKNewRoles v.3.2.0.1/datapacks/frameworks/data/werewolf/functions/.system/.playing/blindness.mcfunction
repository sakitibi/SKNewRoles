execute unless score GameManager glowing_successed matches 1 run execute if data storage sys: random_event.13{active:1} run execute if data storage sys: {time_query:15000} run effect give @s blindness 1 255 true
execute unless score GameManager glowing_successed matches 1 run execute if data storage sys: random_event.13{active:1} run execute if data storage sys: {time_query:15000} run effect give @s darkness 1 255 true
execute unless score GameManager glowing_successed matches 1 run execute if data storage sys: random_event.13{active:1} run execute if data storage sys: {time_query:15000} run effect give @s slowness 1 1 true
