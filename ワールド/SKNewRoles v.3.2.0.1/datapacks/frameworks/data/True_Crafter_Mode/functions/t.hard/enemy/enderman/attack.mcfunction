...
#スコアが30で破壊
execute if entity @s[scores={T.HardMoveset2=30..}] facing entity @p eyes rotated ~ 0 positioned ~ ~ ~ unless block ^1 ^ ^1 #True_Crafter_Mode:t.hard/no_dig run setblock ^0.5 ^ ^ air destroy 
execute if entity @s[scores={T.HardMoveset2=30..}] facing entity @p eyes rotated ~ 0 positioned ~ ~ ~ unless block ^-1 ^ ^1 #True_Crafter_Mode:t.hard/no_dig run setblock ^-0.5 ^ ^ air destroy 
execute if entity @s[scores={T.HardMoveset2=30..}] facing entity @p eyes rotated ~ 0 positioned ~ ~ ~ unless block ^ ^ ^1 #True_Crafter_Mode:t.hard/no_dig run setblock ^ ^ ^1 air destroy 

execute if entity @s[scores={T.HardMoveset2=30..}] facing entity @p eyes rotated ~ 0 positioned ~ ~1 ~ unless block ^1 ^ ^1 #True_Crafter_Mode:t.hard/no_dig run setblock ^0.5 ^ ^ air destroy 
execute if entity @s[scores={T.HardMoveset2=30..}] facing entity @p eyes rotated ~ 0 positioned ~ ~1 ~ unless block ^-1 ^ ^1 #True_Crafter_Mode:t.hard/no_dig run setblock ^-0.5 ^ ^ air destroy 
execute if entity @s[scores={T.HardMoveset2=30..}] facing entity @p eyes rotated ~ 0 positioned ~ ~1 ~ unless block ^ ^ ^1 #True_Crafter_Mode:t.hard/no_dig run setblock ^ ^ ^1 air destroy 

execute if entity @s[scores={T.HardMoveset2=30..}] facing entity @p eyes rotated ~ 0 positioned ~ ~2 ~ unless block ^1 ^ ^1 #True_Crafter_Mode:t.hard/no_dig run setblock ^0.5 ^ ^ air destroy 
execute if entity @s[scores={T.HardMoveset2=30..}] facing entity @p eyes rotated ~ 0 positioned ~ ~2 ~ unless block ^-1 ^ ^1 #True_Crafter_Mode:t.hard/no_dig run setblock ^-0.5 ^ ^ air destroy 
execute if entity @s[scores={T.HardMoveset2=30..}] facing entity @p eyes rotated ~ 0 positioned ~ ~2 ~ unless block ^ ^ ^1 #True_Crafter_Mode:t.hard/no_dig run setblock ^ ^ ^1 air destroy 
