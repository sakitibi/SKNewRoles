# すいすい
    ...
    execute as @e[tag=T.HardRotFix,limit=1,sort=nearest] run tp @s ~ ~ ~ facing entity @e[type=#True_Crafter_Mode:t.hard/piglin_enemy,limit=1,sort=nearest] eyes
    data modify entity @s Rotation[0] set from entity @e[tag=T.HardRotFix,limit=1,sort=nearest] Rotation[0]
    execute facing entity @p feet run function True_Crafter_Mode:t.hard/move
...
# 色々ややこしい理由があるのだ
    ...
    data merge entity @s {DeathLootTable:"True_Crafter_Mode:t.hard/custom/swiming_piglin"}