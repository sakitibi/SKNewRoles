...
execute if entity @s[tag=T.HardDra2] run function True_Crafter_Mode:t.hard/enemy/ender_dragon/dragon_thunder
...
#めんたま召喚 Dra3
execute if entity @s[nbt={DragonPhase:3},tag=!T.HardDra3_No] run function True_Crafter_Mode:t.hard/enemy/ender_dragon/summon_eyes
...
#ブレス用意でサンダー Dra6
execute if entity @s[nbt={DragonPhase:6},tag=!T.HardDra6_No] run function True_Crafter_Mode:t.hard/enemy/ender_dragon/dragon_thunder
...
#execute if entity @s[nbt={DragonPhase:4},tag=!T.HardDra4_No] run function True_Crafter_Mode:t.hard/enemy/ender_dragon/crystal_respawn
