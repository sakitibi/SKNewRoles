...
execute align xyz positioned ~ ~-1 ~ unless entity @e[type=marker,tag=amc,distance=..0.5] positioned ~ ~1 ~ run function Adv_Map_Creator_data:amc/set_block/crops/beetroots
execute align xyz positioned ~ ~-1 ~ unless entity @e[type=marker,tag=amc,distance=..0.5] run summon marker ~ ~ ~ {Tags:["amc","beetroots"]}
