...
execute if entity @s[scores={BulletRemain=1}] run function True_Crafter_Mode:t.hard/move_fb_2
execute if entity @s[scores={BulletRemain=1..},tag=!T.HardNoHoming] run function True_Crafter_Mode:t.hard/move_fb_2
