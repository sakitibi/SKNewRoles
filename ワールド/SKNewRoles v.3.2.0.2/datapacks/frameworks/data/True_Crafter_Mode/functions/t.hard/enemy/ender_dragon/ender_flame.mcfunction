...
execute unless block ^ ^ ^0.7 #True_Crafter_Mode:t.hard/no_enderflame run tag @s add T.HardHit
execute unless block ^ ^ ^0.7 #True_Crafter_Mode:t.hard/no_enderflame run tag @s add T.HardHiT.Block
