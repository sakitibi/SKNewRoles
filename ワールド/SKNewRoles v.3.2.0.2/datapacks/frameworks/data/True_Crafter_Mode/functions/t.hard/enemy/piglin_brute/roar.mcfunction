...
execute as @e[type=piglin,distance=..60] at @s run data modify entity @s Brain.memories."minecraft:angry_at".value set from entity @e[type=#True_Crafter_Mode:t.hard/piglin_enemy,tag=!T.HardException,limit=1,sort=nearest] UUID
