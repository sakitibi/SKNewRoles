...
#13
execute if data storage sys: random_event{recent_event:13} run function werewolf:random_event/shingetsu_night/.start
#14
execute if entity @a[team=Blacksnowgirl] if data storage sys: random_event{recent_event:14} run function werewolf:random_event/snow_storm/.start