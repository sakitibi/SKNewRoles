...
# 狂人薬師
    #治癒
        execute as @a[predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/kyoujinkusushi_health_skill_cooltime,scores={right_click=1..},predicate=!werewolf:is_sneaking] run tellraw @s {"text":"初日の昼はスキルが使えない。"}
    #寛解
        execute as @a[predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/kyoujinkusushi_kankai_skill_cooltime,scores={right_click=1..},predicate=!werewolf:is_sneaking] run tellraw @s {"text":"初日の昼はスキルが使えない。"}
# ポイゾナー
    execute as @a[predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/poisoner_skill_cooltime,scores={right_click=1..},predicate=!werewolf:is_sneaking] run tellraw @s {"text":"初日の昼はスキルが使えない。"}
# 黒雪少女
    execute as @a[predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/blacksnowgirl_skill_cooltime,scores={right_click=1..},predicate=!werewolf:is_sneaking] run tellraw @s {"text":"初日の昼はスキルが使えない。"}
# 自爆魔
    #キル
        execute as @a[predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/jibakuma_slash_skill_cooltime,scores={right_click=1..},predicate=!werewolf:is_sneaking] run tellraw @s {"text":"初日の昼はスキルが使えない。"}
    #自爆
        execute as @a[predicate=werewolf:look_at/look_at_player/look_at_players,predicate=werewolf:have_skill/jibakuma_bomb_skill_cooltime,scores={right_click=1..},predicate=!werewolf:is_sneaking] run tellraw @s {"text":"初日の昼はスキルが使えない。"}