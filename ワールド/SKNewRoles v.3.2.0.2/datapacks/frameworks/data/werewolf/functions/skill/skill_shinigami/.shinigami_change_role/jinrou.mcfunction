...
execute if data storage sys: role.shinigami{stole:Blacksnowgirl} run function werewolf:skill/skill_shinigami/change_role/change_Blacksnowgirl
execute if data storage sys: role.shinigami{stole:Jibakuma} run function werewolf:skill/skill_shinigami/change_role/change_jibakuma