...
# マッドシーア
    execute as @a[team=Madseer,scores={skill_madseer_cooltime=0}] run loot replace entity @s hotbar.8 loot werewolf:skill/madseer_skill/
    execute as @a[team=Madseer,scores={skill_madseer_cooltime=1..}] run loot replace entity @s hotbar.8 loot werewolf:skill/madseer_skill/cooltime
# しろいぬ
    execute as @a[team=Shiroinu,scores={skill_shiroinu_cooltime=0}] run loot replace entity @s hotbar.8 loot werewolf:skill/shiroinu_skill/
    execute as @a[team=Shiroinu,scores={skill_shiroinu_cooltime=1..}] run loot replace entity @s hotbar.8 loot werewolf:skill/shiroinu_skill/cooltime
# コミュナー
...
# 狂人薬師
    ...
    # 治癒
        execute as @a[team=Kyoujinkusushi,scores={skill_kyoujinkusushi_health_cooltime=0}] run loot replace entity @s hotbar.8 loot werewolf:skill/kyoujinkusushi_health_skill/
        execute as @a[team=Kyoujinkusushi,scores={skill_kyoujinkusushi_health_cooltime=1..}] run loot replace entity @s hotbar.8 loot werewolf:skill/kyoujinkusushi_health_skill/cooltime
    # 寛解
        execute as @a[team=Kyoujinkusushi,scores={skill_kyoujinkusushi_kankai_cooltime=0}] run loot replace entity @s hotbar.8 loot werewolf:skill/kyoujinkusushi_kankai_skill/
        execute as @a[team=Kyoujinkusushi,scores={skill_kyoujinkusushi_kankai_cooltime=1..}] run loot replace entity @s hotbar.8 loot werewolf:skill/kyoujinkusushi_kankai_skill/cooltime
# ポイゾナー
    execute as @a[team=Poisoner,scores={skill_poisoner_cooltime=0}] run loot replace entity @s hotbar.8 loot werewolf:skill/poisoner_skill/
    execute as @a[team=Poisoner,scores={skill_poisoner_cooltime=1..}] run loot replace entity @s hotbar.8 loot werewolf:skill/poisoner_skill/cooltime
# 黒雪少女
    #クールタイム設定
    execute as @a[scores={skill_blacksnowgirl_cooltime=1..},predicate=werewolf:set_skill/blacksnowgirl_skill] run loot replace entity @s hotbar.8 loot werewolf:skill/blacksnowgirl_skill/cooltime
    execute as @a[scores={skill_blacksnowgirl_cooltime=0},predicate=werewolf:set_skill/blacksnowgirl_skill_cooltime] run loot replace entity @s hotbar.8 loot werewolf:skill/blacksnowgirl_skill/
# 自爆魔
    #スキルチェンジ
    ...
    # キル
        execute as @a[team=Jibakuma,scores={skill_jibakuma_slash_cooltime=0}] run loot replace entity @s hotbar.8 loot werewolf:skill/jibakuma_slash_skill/
        execute as @a[team=Jibakuma,scores={skill_jibakuma_slash_cooltime=1..}] run loot replace entity @s hotbar.8 loot werewolf:skill/jibakuma_slash_skill/cooltime
    # 自爆
        execute as @a[team=Jibakuma,scores={skill_jibakuma_bomb_cooltime=0}] run loot replace entity @s hotbar.8 loot werewolf:skill/jibakuma_bomb_skill/
        execute as @a[team=Jibakuma,scores={skill_jibakuma_bomb_cooltime=1..}] run loot replace entity @s hotbar.8 loot werewolf:skill/jibakuma_bomb_skill/cooltime