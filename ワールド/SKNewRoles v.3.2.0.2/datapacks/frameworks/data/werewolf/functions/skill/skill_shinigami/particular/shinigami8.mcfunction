execute as @a[tag=8] run function werewolf:skill/skill_shinigami/.shinigami_store_role
function werewolf:skill/skill_shinigami/.shinigami_change_role
tag @a[tag=8] add copying
function werewolf:skill/skill_shinigami/.shinigami_copy_scoreboard
tag @a[tag=8] remove copying
tellraw @s [{"selector":"@a[tag=8]"},{"text":"の能力を得た。"}]
