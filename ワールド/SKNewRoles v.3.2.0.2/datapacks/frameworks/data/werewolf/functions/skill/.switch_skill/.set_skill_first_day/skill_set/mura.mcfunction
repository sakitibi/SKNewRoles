...
execute as @a[team=Snowgirl] run loot replace entity @s hotbar.8 loot werewolf:skill/snowgirl_skill/cooltime
execute as @a[team=Taoruboshi] run loot replace entity @s hotbar.8 loot werewolf:skill/taoruboshi_skill/cooltime
