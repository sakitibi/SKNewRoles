# スキル関連
    ...
    # 雪女スキル
        scoreboard players add @a skill_snowgirl_cooltime 0
    #スキル最大回数を指定(0なら無制限)
        execute unless score GameManager skill_snowgirl_limit matches 0.. run scoreboard players set GameManager skill_snowgirl_limit 1
    #回復タイミングを指定(n/日)
        execute unless score GameManager skill_snowgirl_frequency matches 0.. run scoreboard players set GameManager skill_snowgirl_frequency 1
    # タオル干しスキル
        scoreboard players add @a skill_taoruboshi_cooltime 0
    #スキル最大回数を指定(0なら無制限)
        execute unless score GameManager skill_taoruboshi_limit matches 0.. run scoreboard players set GameManager skill_taoruboshi_limit 1
    #回復タイミングを指定(n/日)
        execute unless score GameManager skill_taoruboshi_frequency matches 0.. run scoreboard players set GameManager skill_taoruboshi_frequency 1
