...
# あられ少女
    #クールタイム設定
    execute as @a[scores={skill_araregirl_cooltime=1..},predicate=werewolf:set_skill/araregirl_skill] run loot replace entity @s hotbar.8 loot werewolf:skill/araregirl_skill/cooltime
    execute as @a[scores={skill_araregirl_cooltime=0},predicate=werewolf:set_skill/araregirl_skill_cooltime] run loot replace entity @s hotbar.8 loot werewolf:skill/araregirl_skill/