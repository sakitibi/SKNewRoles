...
execute if data storage sys: {time_query:6000} as @a unless score @s skill_snowgirl_frequency matches 0 run scoreboard players remove @s skill_snowgirl_frequency 1
execute if data storage sys: {time_query:6000} as @a unless score @s skill_taoruboshi_frequency matches 0 run scoreboard players remove @s skill_taoruboshi_frequency 1
# スキル回復
...
execute if data storage sys: {time_query:6000} as @a if score @s skill_snowgirl_frequency matches 0 unless score @s skill_snowgirl_limit matches 0 run scoreboard players set @s skill_snowgirl_cooltime 0
execute if data storage sys: {time_query:6000} as @a if score @s skill_taoruboshi_frequency matches 0 unless score @s skill_taoruboshi_limit matches 0 run scoreboard players set @s skill_taoruboshi_cooltime 0