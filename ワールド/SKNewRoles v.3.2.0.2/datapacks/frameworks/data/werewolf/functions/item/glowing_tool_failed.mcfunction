execute if entity @a[tag=glowing_failed] run effect give @a[team=Yakousei] night_vision 100 255 true
execute if entity @a[tag=glowing_failed] run effect give @a[tag=no_jinrou,team=!Tenkai,team=!Fusanka,team=!Yakousei] blindness 100 255 true
execute if entity @a[tag=glowing_failed] run effect give @a[tag=no_jinrou,team=!Tenkai,team=!Fusanka,team=!Yakousei] darkness 100 255 true
