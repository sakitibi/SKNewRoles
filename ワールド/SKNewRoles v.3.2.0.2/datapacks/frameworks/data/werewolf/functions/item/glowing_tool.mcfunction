...
execute unless entity @a[team=Witch] run scoreboard players set GameManager glowing_successed 1
execute if entity @a[team=Witch] run function werewolf:item/glowing_tool_failed
item replace entity @s weapon.mainhand with air
execute unless entity @a[team=Witch] run schedule function werewolf:item/glowing_tool_clear 15s append false