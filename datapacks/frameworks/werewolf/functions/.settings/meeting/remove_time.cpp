...
int main() {
    std::cout << "execute if score #GameManager set_meeting_time matches 2400.. run scoreboard players remove #GameManager set_meeting_time 1200" << std::endl;
    ...
    std::cout << "function werewolf:.settings/view_settings_skill" << std::endl;
    return 0;
}
